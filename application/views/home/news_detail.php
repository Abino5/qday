...
<div class="wrapper">
    ...
    <div class="span7 form-inline section-container" id="main">
        ...
        <div class="feeds-container">
            <div class="feed"><div class="feed-title"><div class="feed-title-text">{{=title=}}</div><div class="feed-source">{{=pubdate=}}</div></div> <div class="feed-thumbnail"><div><img class="feed-image backup-image" src="{{=image=}}" /></div><div style="clear: both;"></div></div> <div class="feed-description"> <p class="feed-description-text">{{=description=}} </p><a class="d_link" href="http://localhost/ominzy/home/news/"><div class="feed-description-readmore"><<< BACK</div></a> </div> <div class="feed-reaction"></div> </div>
        </div>
    </div>
