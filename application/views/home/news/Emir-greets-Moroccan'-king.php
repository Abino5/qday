...
<div class="wrapper">
    <div class="span4 form-inline section-container" id="user-info">
        <div class="user-image">
            <div class="user-image-content">
                ...
                <p align="center" class="user-name">Abe</p>
            </div>
    ...
    <div class="span7 form-inline section-container" id="main">
        ...
        <div class="feeds-container">
            <div class="feed"><div class="feed-title"><div class="feed-title-text">Emir greets Moroccan king</div><div class="feed-source">Fri, 29 Apr 2016 00:44:28 GMT</div></div> <div class="feed-thumbnail"><div><img class="feed-image backup-image" src="http://www.Gulf-Times.com/Content/Upload/Slider/420162904136407551492.jpg" /></div><div style="clear: both;"></div></div> <div class="feed-description"> <p class="feed-description-text"><br/><span style="font-family: Tahoma;">HH the Emir Sheikh Tamim bin Hamad al-Thani welcomes King Mohammed VI of Morocco upon his arrival in Doha yesterday. The two leaders held official talks at the Emiri Diwan in the evening. Besides reviewing bilateral relations and ways to enhance them, their talks dealt with issues of interest to the two countries, particularly the developments in the region, including the situation in Palestine, Syria and Yemen.&nbsp;</span> </p><a class="d_link" href="http://localhost/ominzy/home/news/"><div class="feed-description-readmore"><<< BACK</div></a> </div> <div class="feed-reaction"></div> </div>
        </div>
    </div>
