        ...
        <div class='container-settings'>
            ...
            <table class="settings-table">
                ...
                <tr>
                    ...
                    <td class="td-right"><input placeholder="Abduselam" type="text" class="form-control input-reg-semi-full settings-input"><button type="submit" class="btn btn-success settings-btns">Change</button> </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="td-right"><input type="text" placeholder="Eritrea" class="form-control input-reg-semi-full settings-input"><button type="submit" class="btn btn-success settings-btns">Change</button>  </td>
                </tr>
                <tr>
                    <td class="td-left">Phone:</td>
                    <td class="td-right"><input type="text"placeholder="0097450516625"  class="form-control input-reg-semi-full settings-input"><button type="submit" class="btn btn-success settings-btns">Change</button>  </td>
                </tr>
                <tr>
...
<div class="wrapper">
    <div class="span4 form-inline section-container" id="user-info">
        <div class="user-image">
            <div class="user-image-content">
                ...
                <p align="center" class="user-name">AbduselamOmer</p>
            </div>
    ...
    <div class="span7 form-inline section-container" id="main">
        ...
        <div class="feeds-container">
            <div class="feed"><div class="feed-title"><div class="feed-title-text">Another hot day expected in Qatar</div><div class="feed-source">Wed, 27 Apr 2016 21:39:43 GMT</div></div> <div class="feed-thumbnail"><div><img class="feed-image backup-image" src="http://www.Gulf-Times.com/Content/Upload/Slider/12016121840530254263.jpg" /></div><div style="clear: both;"></div></div> <div class="feed-description"> <p class="feed-description-text"><br/>Cloudy conditions are expected between Thursday evening and Sunday along with chances of light, isolated rain, the Qatar Met department has said.<br />
The weather report also states that another hot day is expected in the country on Thursday.<br />
A post on the Met department&rsquo;s social media channels on Wednesday said the maximum temperature was 39C in Al Batna and Al Karaana, while it ranged between 32C and 38C in other parts of Qatar.<br />
The maximum temperature expected in the country on Thursday is 39C at Abu Samra, while the forecast for Doha is 37C.<br />
The weather in inshore areas will be relatively hot during the day and some clouds are also likely. <br />
Offshore areas, meanwhile, will see hazy to misty conditions in some places, according to the report. </p><a class="d_link" href="http://localhost/ominzy/home/news/"><div class="feed-description-readmore"><<< BACK</div></a> </div> <div class="feed-reaction"></div> </div>
        </div>
    </div>
