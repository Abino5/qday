...
<div class="wrapper">
    ...
    <div class="span7 form-inline section-container" id="main">
        ...
        <div class="feeds-container">
            <div class="feed"><div class="feed-title"><div class="feed-title-text">High-speed trading backlash puts pressure on India’s Sebi</div><div class="feed-source">Fri, 29 Apr 2016 20:20:50 GMT</div></div> <div class="feed-thumbnail"><div><img class="feed-image backup-image" src="http://www.Gulf-Times.com/Content/Upload/Slider/4201629202044144866010.jpg" /></div><div style="clear: both;"></div></div> <div class="feed-description"> <p class="feed-description-text"><br/>India&rsquo;s markets regulator is coming under increased pressure to improve its oversight of high-speed trading after allegations of unfair access at the nation&rsquo;s biggest equity bourse.<br />
The country&rsquo;s top brokerage associations are among a growing chorus of voices calling for the Securities and Exchange Board of India (Sebi) to take action after an investigation by one of its own advisory panels claimed that there may have been collusion between the National Stock Exchange of India and a high-frequency trading firm. <br />
The panel is pushing for Sebi to frame more detailed rules on HFT and punish anyone found of wrongdoing, according to a person with direct knowledge of the matter.<br />
Sebi&rsquo;s public silence on the internal report&rsquo;s findings - which were reported by Bloomberg and local media this month - has added to a sense of frustration among many local brokers and investors who say that insufficient regulations on high- frequency trading have made India&rsquo;s markets vulnerable to abuse. <br />
While Sebi has issued broad guidelines dating as far back as 2012, critics argue they don&rsquo;t do enough to address how traders should connect to exchanges and how orders should be processed.<br />
&ldquo;India doesn&rsquo;t have formal rules for HFT,&rdquo; Vaibhav Sanghavi, a managing director and portfolio manager at Ambit Investment Advisors, which runs India&rsquo;s only onshore long-short fund that has 10bn rupees in assets, said in an interview. &ldquo;Sebi will have to get proactive.&rdquo;<br />
The regulator is discussing what steps to take with the Technical Advisory Committee, said the person with direct knowledge, who asked not to be named because the discussions are private. Sebi hasn&rsquo;t decided on its response, the person said.<br />
While Sebi Chairman UK Sinha met with brokers in Mumbai on April 21, he didn&rsquo;t comment directly on the panel&rsquo;s findings, saying only that Sebi will ensure a &ldquo;level-playing field,&rdquo; according to Swatantra Kumar Rustagi, president of the Association of National Exchanges Members of India, who attended the meeting. The rising share of algorithmic orders poses &ldquo;systemic risks,&rdquo; the Reserve Bank of India said last year. Sebi didn&rsquo;t reply to e-mailed questions. An NSE spokesman didn&rsquo;t respond to an e-mail seeking comment. <br />
The bourse will in the coming weeks submit a detailed report to Sebi to counter claims that high-frequency traders gained unfair access, people with knowledge of the matter said this week.<br />
The report by the Sebi&rsquo;s advisory panel, which hasn&rsquo;t been released, said that between 2012 and 2014, NSE handled orders to trade on a first-come, first-served basis, a design that made it prone to abuse. <br />
The panel, whose work was prompted by claims from an unidentified whistle-blower, said it didn&rsquo;t have enough information to determine whether NSE officials colluded with traders </p><a class="d_link" href="http://localhost/ominzy/home/news/"><div class="feed-description-readmore"><<< BACK</div></a> </div> <div class="feed-reaction"></div> </div>
        </div>
    </div>
